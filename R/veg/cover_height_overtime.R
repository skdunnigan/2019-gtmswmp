...
# percent cover
cover <- ggplot(data = a, aes(x = year_season, y = mean_cover, group = species, color = species)) +
  geom_point(size = 3) +
  geom_line(size = 1) +
...
# canopy heights
height <- ggplot(data = a, aes(x = year_season, y = mean_ht, group = species, color = species)) +
  geom_point(size = 3) +
  geom_line(size = 1) +
